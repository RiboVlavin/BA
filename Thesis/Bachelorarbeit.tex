...
Die Analyse der Mutationsraten zwischen den Proteinen NS2A, NS3 und NS4B des Dengue-Virus zeigen signifikante Unterschiede in der Konservierung dieser. W\"ahrend NS3 und NS4B, die beide Transmembrandom\"anen aufweisen, sich in \"Ubereinstimmung mit den Erwartungen als stark konserviert herausstellen, zeigt NS2A eine unerwartet hohe Mutationsrate. Diese Beobachtung wirft Fragen zur evolution\"aren Dynamik und zur funktionalen Rolle von NS2A auf. Transmembranproteine sind in der Regel stark konserviert, da ihre Struktur und Funktion eng mit den hydrophoben Anforderungen und den polar requirements ihrer Umgebung verbunden sind. In diesem Kontext ist es nicht \"uberraschend, dass NS3 und NS4B, die beide in die Membran integriert sind, eine hohe Konservierung aufweisen. Diese Proteine sind entscheidend f\"ur die virale Replikation und Interaktion mit zellul\"aren Komponenten, was ihre strukturelle Integrit\"at und Funktionalit\"at erfordert. Im Gegensatz dazu besteht die hohe Mutationsrate von NS2A. Dieses Protein hat zwar einen signifikanten Anteil an seiner Struktur, der in der Membran verankert ist, was normalerweise auf eine starke Konservierung hindeutet. Dennoch zeigen unsere Ergebnisse, dass NS2A eine der am st\"arksten mutierten Regionen im Dengue-Virus darstellt. Diese Diskrepanz k\"onnte durch die spezifische Funktion von NS2A erkl\"art werden. NS2A spielt eine entscheidende Rolle bei der Virusbildung und der Modulation der Immunantwort des Wirts. Es befindet sich an der Au\ss{}enseite der infizierten Zelle und ist somit direkt dem Immunsystem ausgesetzt. Um einer Erkennung durch die Immunabwehr zu entgehen, k\"onnte das Virus gezwungen sein, dieses Protein regelm\"a\ss{}ig zu mutieren. Diese Mutation erm\"oglicht es dem Virus, seine antigenen Eigenschaften zu variieren und somit dem Immunsystem zu entkommen.
Zusammenfassend l\"asst sich sagen, dass die hohe Mutationsrate von NS2A nicht nur ein Ergebnis seiner strukturellen Eigenschaften ist, sondern vielmehr eine evolution\"are Anpassung darstellt, um die \"Uberlebensf\"ahigkeit des Virus in einem dynamischen immunologischen Umfeld zu sichern. Dadurch l\"asst sich durch die Ergebnisse nicht abschlie\ss{}end beurteilen, ob das Protein auch in den Transmebrandom\"anen stark mutiert und die hohe Mutationsrate durch die Funktionalit\"at in Bezug auf die Imunabwehr begr\"undet werden kann. Um daf\"ur eine abschlie\ss{}ende Antwort zu finden, sollte dieses Protein genauer untersucht werden und die Mutationsraten in den einzelnen Dom\"anen aufgeschl\"usselt werden. 

Durch die Ergebnisse l\"asst sich also nicht abschlie\ss{}end kl\"aren, ob Transmembrandom\"anen stark konserviert sind in Bezug auf Polar requirements und Hydropathie. Die Daten geben keine eindeutige Antwort, weshalb eine weitere Untersuchung der Proteine sinnvoll erscheint. Die Proteine sollten dabei in Bezug auf ihre Dom\"anen getestet werden, um herauszufinden, ob einzelne Proteine, trotz ihrem generell hohen Mutationsdruck aufgrund von funktionellen Eigenschaften, in den Transmebrandom\"anen besonders stark konserviert sind. 

\section{Datens\"atze erweitern}
Um die Datengrundlage zu erweitern muss das Programm angepasst werden. Dabei gibt es zwei m\"ogliche Richtungen, in die das Programm weiter entwickelt werden kann. Entweder man schaut sich die Proteine n\"aher an und untersucht zum Beispiel die Dom\"anen spezifisch f\"ur einzelne Proteine oder man erweitert den Datensatz auf mehr verschiedene DNA-Str\"ange und untersucht mehr als nur das Dengue-Virus. 
\subsection{Dom\"anen untersuchen}
Die gegenw\"artige Analyse konzentriert sich auf die Serotypen des Dengue-Virus und untersucht spezifisch die einzelnen Proteine, ohne dabei die zugrunde liegenden Dom\"anen zu ber\"ucksichtigen. Diese Fokussierung bietet wertvolle Einblicke in die Mutationsdynamik der Proteine, jedoch k\"onnte eine Erweiterung der Datengrundlage sinnvoll sein, um herauszufinden, ob einzelne Proteine, trotz ihrem generell hohen Mutationsdruck, in den Transmebrandom\"anen besonders stark konserviert sind. Insbesondere w\"are es m\"oglich, den bestehenden Code auf die Analyse der Transmembrandom\"anen auszuweiten, um ein detaillierteres Verst\"andnis der konservativen Eigenschaften in Bezug auf Polar requirements und Hydropathie zu erlangen. Daf\"ur m\"usste man entweder h\"andisch einen Ordner f\"ur jedes Protein erstellen, in denen jede Dom\"ane f\"ur das entsprechende Protein eine eigene FASTA-Datei bekommt und in jeder dieser FASTA-Datei f\"ur jeden Serotypen den entscheidenen DNA-Abschnitt reinkopiert wurde. Alle diese einzelnen FASTA-Dateien m\"ussen auch einzelnd ausgerichtet werden. Dann kann der ganze Ordner bereits eingelesen und berechnet werden, ohne das Programm weiter anpassen zu m\"ussen. Da das aber f\"ur jedes Protein einen gr\"o\ss{}eren Aufwand erfordert diese einzelnen Dateien zu erstellen, kann man das vorhandene Programm auch verwenden, um sich Ordner automatisch erstellen zu lassen. Hierbei ist zu beachten, dass das Programm aktuell nur f\"ur das ganze Polyprotein einen Ordner erstellen kann, in dem die Proteine einzelnd kopiert werden. N\"aheres wurde bereits in dem Kapitel Materialien und Methoden beschrieben. Dieses Programmteil kann man aber auch erweitern, um sich die neue Ordnerstruktur automatisch erstellen zu lassen und den Arbeitsumfang zu reduzieren. 
Das anpassen des Programms, um die eingegebenen Viren auf Dom\"anen und nicht nur auf Proteine zu untersuchen ist also m\"oglich, aber kann sich als sehr zeitaufwendig herausstellen, deswegen sollte man den aktuell existierenden Code erweitern, um sich die geforderte Ordnerstruktur automatisch erstellen zu lassen. 
\subsection{Mehr Viren und DNA-Str\"ange untersuchen}
Um die Fragestellung abschlie\ss{}end zu kl\"aren, muss der Datensatz auf weitere DNA-Str\"ange ausgeweitet werden. Nur eine umfassendere Datengrundlage w\"urde es erm\"oglichen, festzustellen, ob die beobachteten Muster spezifisch f\"ur das Dengue-Virus sind oder ob sie auch auf andere Viren zutreffen. Allerdings ist es wichtig zu beachten, dass der Vergleich verschiedener Viren in kleinen Datens\"atzen nicht zielf\"uhrend ist. Die Literatur unterst\"utzt die Auffassung, dass eine eingehende Analyse eines einzelnen Virus sinnvoller ist, um pr\"azise Ergebnisse zu erzielen.(Hier auf Ninas Arbeit verweisen) Dennoch ist es notwendig, \"uber das Dengue-Virus hinauszugehen und weitere Viren zu untersuchen, um allgemeing\"ultige Aussagen \"uber die Konservierung von Transmembrandom\"anen treffen zu k\"onnen.
Das Programm erlaubt die Eingabe von allen m\"oglichen DNA-Datens\"atzen und ist nicht in sich auf das Dengue-Virus beschr\"ankt. Es ist also bereits jetzt m\"oglich die Eingaben gegen eine andere DNA-Sequenz auszutauschen oder den Code dahingehen zu erweitern mehr Eingaben einlesen und ausrechnen zu lassen. Es ist aber nicht ohne gr\"o\ss{}eren Aufwand m\"oglich, da man f\"ur das Berechnen der Werte f\"ur einzelne Proteine einen Ordner mit FASTA-Dateien erstellen muss. N\"aheres ist im Kapitel Materialien und Methoden beschrieben. Dort muss man h\"andisch einige Dateien zusammenkopieren und ausrichten. Dies ist bei kleinen Datens\"atzen m\"oglich, wird aber schnell sehr zeitaufw\"andig, wodurch das keine sinnvolle M\"oglichkeit bei gro\ss{}en Datens\"atzen darstellt. Je mehr Proteine untersucht werden sollen, desto h\"oher wird der Zeitaufwand. Auch wenn es mehr Serotypen pro Virus gibt, steigt der ben\"otigte Zeitaufwand. Es wird an dieser Stelle also notwendig das Programm zu erweitern und das Einlesen von Dateien zu vereinfachen. Daf\"ur kann auch das Ausrichten der Datens\"atze automatisiert werden, indem die Proteine automatisch aus GenBank Dateien nicht nur gefunden werden k\"onnen, sondern auch mit den gleichen Proteinen aus anderen Serotypen gematcht werden k\"onnen, um eine gemeinsame Datei daraus zu erstellen. Dieser Schritt ist aber sehr aufw\"andig, da die Daten aus GenBank nicht vollst\"andig standatisiert sind und das matching dadurch kein simpler Prozess ist. Das Protein 2K im Dengue virus wurde beispielsweise in der einen Arbeit mit "`Protein 2K"' benannt und in der anderen Arbeit mit "`2K Protein"'. Der matching Algorithmus muss also darauf trainiert sein mit nat\"urlicher Sprache umgehen zu k\"onnen und diese Strings als inhaltlich identisch betrachten zu k\"onnen. (Dazu am besten noch Literatur finden, die besagt, dass matching Algorithmen f\"ur natr\"utliche Sprachen sehr komplex sind und Gegenstand aktueller Forschung sind.) 
Um diesen komplexen Matching-Prozess zu umgehen, kann man auch darauf verzichten die DNA-Str\"ange in spezifische Bereiche, wie Proteine, zu unterteilen. Alternativ kann man den DNA-Strang nur in gleich gro\ss{}e Bereiche auteilen. Das wurde in dieser Arbeit bereits bei Abbildung \ref{fig:Dengue_virus_scores_and_mutations_bereiche} getan und im Kaptitel Materialien und Methoden beschrieben. 

Dar\"uber hinaus wurde das aktuelle Programm in Python entwickelt, was zwar f\"ur kleinere Datens\"atze praktikabel ist, jedoch bei gr\"o\ss{}eren Datens\"atzen und komplexeren Analysen an seine Leistungsgrenzen st\"o\ss{}t. Dies k\"onnte potenzielle Herausforderungen bei der Implementierung und Auswertung gr\"o\ss{}erer Datenmengen mit sich bringen. Python ist nicht auf Performanz optimiert, weshalb gro\ss{}e Datenmengen daf\"ur sorgen werden, dass die Berechnungen nicht mehr in einer sinnvollen Zeit abgeschlossen werden. Auch T-Coffee, das genutze Ausrichtungswerkzeug, ist nicht auf gro\ss{}e Datenmengen optimiert. Es ist ein sehr pr\"azises Ausrichtungswerkzeug und deshalb geeignet auch kurze DNA-Str\"ange sinnvoll auszurichten. Bei gro\ss{}en Datenmengen und langen DNA-Str\"angen, kann es sinnvoll sein schnellere und weniger pr\"azise Ausrichtungswerkzeuge zu verwenden, da einzelne Fehler in gro\ss{}en Datens\"atzen nicht so sehr ins Gewicht fallen und eine geringere Pr\"azision trotzdem ausreichend sein kann. 
 
- Bei gro\ss{}en Datens\"atzen lohnt es sich also mindestens nur in naive Bereichsaufteilungen zu suchen, anstellen die exakten Proteine zu suchen und h\"andisch daf\"ur Dateien zu erstellen. Wobei auch das Grenzen hat und man irgendwann auch das Ausrichten der Daten automatisieren muss. (Da ja bereits ausgerichtete Daten ben\"otigt werden). 
- Au\ss{}erdem ist T-Coffee f\"ur gro\ss{}e Daten nicht optimal -> T-Coffee sehr pr\"azise, was insbesondere bei diesen kleinen Datenmengen von relevanz ist, aber f\"ur gro\ss{}e Datenmengen ist T-Coffee vllt. nicht performant genug und sollte durch andere Ausrichtungsverfahren ersetzt werden. 

\section{Die Berechnungsgrundlagen}
\subsection{Mutationen}
- gaps z\"ahlen? -> keine \"Anderung des Scores, weil gaps nicht beachtet werden/ keinen Wert besitzen 
- sollten mehrere Mutationen an einer Stelle mehrfach gez\"ahlt werden?
\subsection{PR/H Warum? - maybe direkt in M/M}
- Bei Hydropathie 4 Werte wurden nachtr\"aglich h\"andisch angepasst siehe M/M -> wie sinnvoll sind die genutzen Werte? Oder wie sicher korrekt? 
- PR: gibt noch andere Wertemodelle (zitieren), die anders erhoben wurden (in vitro nicht wetlab) -> das verwendete Wertemodell also vermutlich veraltet und nicht ganz korrekt -> Abweichungen sind aber eher minimal, deswegen betreffen diese \"Anderungen vermutlich nicht die Grundannahmen/ Berechnungen so doll, dass sich der insgesamte Trend deutlich \"andern w\"urde -> sollte f\"ur zuk\"unftige Forschungen aber in betracht gezogen werden
- Insgesamt Nina zitieren
\subsection{Der Score}
- warum Durschnitt und nicht Median? -> wir wollen ja gerade die "`Ausrei\ss{}er erkennen und betrachten, weil beretis ein kleiner Bereich, in dem das Protein die chemischen Eigenschaften komplett \"andert, reicht aus, dass das Protein dann m\"oglicherweise nicht mehr funktionsf\"ahig ist und beispielsweise sich nicht mehr in der Membran verankern kann. (Sollte vllt. eher in M/M)

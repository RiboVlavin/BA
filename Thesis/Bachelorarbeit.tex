...
Warum genau sinnvoll f\"ur diese Arbeit? (Nina referenzieren -> wurde dort auch genutzt, somit geeignet f\"ur Forschung und nur ein Virus, da zwischen Viren in so kleinen Stichproben Vergleiche ziehen nicht zielf\"uhrend ist)
Vorgehen erl\"autern -> Proof of concept mit Dengue-Viren -> Code soll erweiterbar bleiben

...
\UzLThesisSetup{
  ...
  %
  Abstract              = {
   In this bachelor's thesis, the stability of transmembrane regions within viruses, particularly the dengue virus, is investigated concerning hydropathy and polar-requirements values. The analysis of the biochemical foundations shows that hydrophobic and hydrophilic properties are crucial for the interaction of transmembrane proteins with their environment. Using bioinformatics tools, the mutation stability of the transmembrane domains is analyzed, revealing a high conservation in certain areas of the virus, indicating evolutionary pressure. These findings highlight the need for further research to examine specific mutation patterns concerning transmembrane domains.
  },
  Zusammenfassung       = {
  In dieser Bachelorarbeit wird die Stabilit\"at von Transmembranbereichen innerhalb von Viren, insbesondere des Dengue-Virus, in Bezug auf Hydropathie und Polar-requirements untersucht. Die Analyse der biochemischen Grundlagen zeigt, dass hydrophobe und hydrophile Eigenschaften entscheidend f\"ur die Interaktion von Transmembranproteinen mit ihrer Umgebung sind. Mithilfe bioinformatischer Tools wurde die Mutationsstabilit\"at der transmembranen Dom\"anen analysiert, wobei Ergebnisse eine hohe Konservierung in bestimmten Bereichen des Virus aufzeigen, was auf einen evolution\"aren Druck hinweist. Diese Erkenntnisse verdeutlichen die Notwendigkeit weiterer Forschung zur Untersuchung spezifischer Mutationsmuster in Bezug auf transmembrane Dom\"anen.
  },
  %
...
F\"ur Hydropathie berechnen wir die Werte gleicherma\ss{}en. Wir nutzen daf\"ur die Werte aus der Abbildung \ref{fig:Hydropathieindexe} und berechnen die Werte auf die selbe Weise wie bei den Polar-requirements. L\"ucken werden hier auch wieder nicht ber\"ucksichtigt. Wir berechnen also die durchschnittliche Differenz des maximalen und minimalen normierten Hydropathie-Wertes an jeder Stelle der Teilsequenz. F\"ur das Polyprotein des Dengue-Virus ergibt sich dadurch folgende Abbildung \ref{fig:Dengue_virus_hydropathy}. 
\begin{figure}[htpb]
  \centering

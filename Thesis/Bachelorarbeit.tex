...
\node (start) [rectangle, rounded corners, draw] {Datenerfassung};
\node (prep) [rectangle, rounded corners, draw, below of=start] {Datenvorverarbeitung};
\node (calc) [rectangle, rounded corners, draw, below of=prep] {Berechnung der Werte};
\node (anal) [rectangle, rounded corners, draw, below of=calc] {Statistische Analyse};
\node (vis) [rectangle, rounded corners, draw, below of=anal] {Visualisierung};
\node (interp) [rectangle, rounded corners, draw, below of=vis] {Interpretation};

...
\UzLThesisSetup{
  ...
  %
  Abstract              = {
    Hydrophobic and hydrophilic properties are crucial for the interaction of transmembrane proteins with their environment and can be quantified through hydropathy and polar requirement values. This bachelor's thesis investigates the stability of transmembrane proteins of the Dengue virus in relation to these values. The analysis revealed significant conservation in the transmembrane proteins NS3 and NS4B, while NS2A showed unexpectedly high mutation rates. A strong correlation was found between the proportion of mutations and the mutation score in the real virus sequence compared to random permutation, suggesting an evolutionary mechanism for conserving polar requirement and hydropathy. Additionally, a bioinformatics tool was developed that quantifies and visualizes mutation pressures in proteins. These results provide new insights into the mutation mechanisms of the Dengue virus and demonstrate the need for further research at the domain level.
  },
  Zusammenfassung       = {
    Hydrophobe und hydrophile Eigenschaften sind entscheidend f\"ur die Interaktion von Transmembranproteinen mit ihrer Umgebung und k\"onnen durch Hydropathie- und Polar-Requirement-Werte quantifiziert werden. Diese Bachelorarbeit untersucht die Stabilit\"at von Transmembranproteinen des Dengue-Virus in Bezug auf diese Werte. Die Analyse ergab eine signifikante Konservierung in den Transmembranproteinen NS3 und NS4B, w\"ahrend NS2A unerwartet hohe Mutationsraten aufwies. Es wurde eine starke Korrelation zwischen dem Anteil an Mutationen und dem Mutationsscore in der realen Virussequenz im Vergleich zur zuf\"alligen Permutation festgestellt, was auf einen evolution\"aren Mechanismus zur Konservierung von Polar-Requirement und Hydropathie hindeutet. Zudem wurde ein bioinformatisches Tool entwickelt, das Mutationsdr\"ucke in Proteinen quantifiziert und visualisiert. Diese Ergebnisse bieten neue Einblicke in die Mutationsmechanismen des Dengue-Virus und zeigen die Notwendigkeit weiterer Forschung auf Dom\"anenebene auf.
  },
  %
